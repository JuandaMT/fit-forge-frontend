  ...
  template: `
    <div class="ff-macro-ring" [style.--size.px]="size()" [style.--stroke.px]="stroke()">
      <svg viewBox="0 0 100 100" aria-hidden="true">
        <circle class="track" cx="50" cy="50" [attr.r]="radius()" [attr.stroke-width]="strokePct()" fill="none" />
        <circle class="progress" cx="50" cy="50" [attr.r]="radius()" [attr.stroke-width]="strokePct()" fill="none"
